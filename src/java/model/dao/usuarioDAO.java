...
public class usuarioDAO {
    ...
    public void editar(Usuario usuario){
        try {
          Connection conexao = Conexao.conectar();
          PreparedStatement stmt = null;
          stmt = conexao.prepareStatement("UPDATE celular SET marca = ?, modelo = ?, ano = ?, processador = ?, memoriaRAM = ?, armazenamento = ?, sistemaOperacional = ?, cor = ?  WHERE idCelular = ?");
           stmt.setString(1, celular.getMarca());
           stmt.setString(2, celular.getModelo());
           stmt.setInt(3, celular.getAno());
           stmt.setString(4, celular.getProcessador());
           stmt.setString(5, celular.getMemoriaRAM());
           stmt.setString(6, celular.getArmazenamento());
           stmt.setString(7, celular.getSistemaOperacional());
           stmt.setString(8, celular.getCor());
           stmt.setInt(9, celular.getIdCelular());

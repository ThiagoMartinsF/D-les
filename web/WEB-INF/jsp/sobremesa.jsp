                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card card-custom">
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text categoria-text">Categoria:
                                                        ${produto.id_categoria}</p>
                                                    <p class="card-text">Valor: R$ ${produto.preco}</p>
                                                </div>
                                                <button class="btn btn-comprar" data-idproduto="${produto.idProduto}"
                                                    onclick="adicionarItemAoCarrinho('${produto.idProduto}')">COMPRAR</button>
                                            </div>
                                        </div>
                                    </c:if>
                                </c:forEach>
